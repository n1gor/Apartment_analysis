...
#import matplotlib.pyplot import pyplot
...
gm_cv = GridSearchCV(Lasso(), {'alpha': np.logspace(-5,8,15)}, cv = 5)
...
# count = 0
#
# print(pipeline.predict(pd.DataFrame(data, index = [0], columns=x.columns)))
...
# LinearRegression
# Train squared: 0.8416767613225101
# Tuned squared: 0.8407216669327404
